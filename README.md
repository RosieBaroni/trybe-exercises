...
Este repositório contém todas as atividades de aprendizagem desenvolvidas por _[Rosieli Baroni](https://www.linkedin.com/in/rosieli-baroni/)_ enquanto estudava na [Trybe](https://www.betrybe.com/) :rocket:
...
- [x] 3-5: _[Projeto - Lessons Learned](https://github.com/RosieBaroni/project-lessons-learned)_
...
- [x] 4-5: _[Projeto - Playground Functions](https://github.com/RosieBaroni/project-playground-functions)_
...
- [x] 5-6: _[Projeto - Arte com Pixels](https://github.com/RosieBaroni/project-pixels-art)_
- [x] 5-7: _[Projeto - Lista de tarefas](https://github.com/RosieBaroni/project-todo-list)_
...
- [x] 6-6: _[Projeto - Trybewarts](https://github.com/RosieBaroni/project-trybewarts)_
...
- [x] 7-4: _[Projeto - JavaScript Testes Unitários](https://github.com/RosieBaroni/project-js-unit-tests)_
...
- [x] 10-3: _[Projeto - Sistema Solar](https://github.com/RosieBaroni/project-solar-system)_
...
- [x] 24-1: _NodeJS - ORM e Autenticação_
- [x] 24-1: _NodeJS - ORM - Interface da aplicação com o banco de dados_
- [x] 24-2: _NodeJS - ORM - Associations_
- [x] 24-3: _NodeJS - JWT (JSON Web Token)_
- [x] 24-4: _NodeJS - Testando APIs com testes de integração_
- [ ] 27-5: _[Projeto - API de Blogs]()_
